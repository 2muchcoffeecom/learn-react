Для выполнения домашнего задания склонировать репозиторий starter-kit или создать пустой проект при помощи npx create-react-app home-work и выполнить задания.
